        ...
        <section className="px-4 md:px-0 bg-[#F5F5F5] dark:bg-darkmode py-10">
            <div className="container lg:max-w-screen-xl md:max-w-screen-md px-4 mx-auto py-12">
                ...
                >
                    ...
                    {/* --- BAGIAN 1: TEKS (Sekarang di Kiri) --- */}
                    <div className="md:w-2/3 p-8 flex flex-col justify-center text-center md:text-left">
                        <h3 className="text-end text-2xl md:text-3xl font-bold text-black dark:text-white mb-4">
                            Unduh User Guide
                        </h3>
                        
                        <p className="text-end text-gray-500 dark:text-gray-300 text-base md:text-lg mb-8 leading-relaxed">
                        ...
                        {/* Tombol (Warna Biru & Align Kiri di Desktop) */}
                        <div className='flex justify-center '>
                            <Link 
                                href="/kalkulator" 
                                className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-300 uppercase tracking-wider text-sm shadow-md"
                            >
                    ...
                    {/* --- BAGIAN 2: GAMBAR/ICON (Sekarang di Kanan) --- */}
                    {/* Background diubah jadi Biru (bg-blue-500) */}
                    <div className="md:w-1/3 bg-blue-500 flex items-center justify-center p-8 relative min-h-[250px]">
                        
                        {/* Icon SVG Buku Panduan */}
                        <svg 
                            viewBox="0 0 24 24" 
                            fill="none" 
                            className="w-40 h-40 text-white drop-shadow-md transform transition-transform duration-500 hover:scale-105" // Ukuran diperbesar sedikit agar pas
                        ...
                        >
                            ...
                            {/* 2. Grafik Kurva Kecil di Halaman Kanan */}
